...
const ICon = ({ nama }) => {
  if (nama === "Makanan") return <FontAwesomeIcon icon={faUtensils} className="icon me-2" />;
  if (nama === "Minuman") return <FontAwesomeIcon icon={faCoffee} className="icon"/>;
  if (nama === "Cemilan") return <FontAwesomeIcon icon={faCheese} className="icon me-2" />;
